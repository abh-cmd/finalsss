                ...
                <div className="container mx-auto px-4 md:px-8 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex flex-col items-center">
                            <h1 className="text-6xl font-black text-white tracking-widest mb-4 animate-pulse drop-shadow-2xl glow-text-desktop font-serif">
                                SRI SAI INTERIORS
                            </h1>
                            <div className="w-full h-3 bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-400 rounded-full shadow-2xl animate-bounce filter brightness-125 glow-line-desktop"></div>
                        </div>
            ...
            <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 md:hidden ${
                ...
                <div className="container mx-auto px-4 py-3">
                    ...
                    <div className="flex flex-col items-center mt-3">
                        <h1 className="text-2xl font-black text-white tracking-wider mb-2 animate-pulse drop-shadow-xl glow-text-mobile font-serif">
                            SRI SAI INTERIORS
                        </h1>
                        <div className="w-full h-1.5 bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-400 rounded-full shadow-xl animate-bounce filter brightness-125 glow-line-mobile"></div>
                    </div>
                </div>
